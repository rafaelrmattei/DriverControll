...
<html lang="pt_BR">
  ...
  <body class="font-baloo relative h-screen w-screen">
    <x-alerts.error></x-alerts.error>
    <div class="absolute top-0 left-0 h-screen w-screen bg-login-background bg-center bg-cover bg-no-repeat z-0"></div>
    <div class="w-screen h-screen absolute top-0 left-0 bg-white/40 z-1"></div>
    <div class="w-screen h-screen flex items-center justify-center relative">
        <div class="shadow-xl w-72 rounded-md p-10 bg-white">
            <div class="px-5 mb-5"><img src="{{ asset('img/logo.svg') }}" alt="Terra Ciclo"></div>
            <div>
